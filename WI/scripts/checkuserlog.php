...
if (!isset($_SESSION['idx'])) { 
  if (!isset($_COOKIE['idCookie'])) {
     $logOptions = '&nbsp;	
	 <x class="headerBtns" style="margin-top:12px;"><a href="http://' . $dyn_www . '/wi/login.php"><font color="white" size="4" face="axure handwriting">Log In</font></a></x>';
	 $hello = '<a href="http://' . $dyn_www . '/wi/register.php"><font color="black" size="4" face="axure handwriting">Register Account</font></a>';
...
';
	...
	if ($numRows == 0) {
		...
		header("location: index_my.php"); // << makes the script send them to any page we set
		exit();
	}
