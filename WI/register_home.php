...
<table width="807" border="0" align="center" cellpadding="0" cellspacing="0" class="mainBodyTable">
  <tr>
    <td width="807" valign="top">

        <h2 style="margin-left:100px;">Create Your Account </h2>

      <table width="500" align="center" cellpadding="2" cellspacing="0" style="border:#99891px solid; background-color:#FBFBFB;">
        <form action="register_home.php" method="post" enctype="multipart/form-data">
          <tr>
          ...
          <tr>
            ...
            <td width="453" bgcolor="#FFFFFF"><input name="username" type="text" class="formFields" id="username" value="<?php print "$username"; ?>" size="32" maxlength="20" />
              <span id="nameresponse"><span class="textSize_9px"><span class="greyColor">Alphanumeric Characters Only</span></span></span></td>
          </tr>
          <tr>

<td bgcolor="#FFFFFF">Gender: <span class="brightRed">*</span></td>
            <td bgcolor="#FFFFFF"><select name="gender" class="formFields" id="gender"><label>
